function zero(value){
    return value<10?"0"+value:value;
        ...
        // 把时间格式的字符转换成我们的标准时间格式
        // var tagTime =new Date（"2018-1-1 0:0:0"）但是这种格式有兼容问题，在IE6~8下，所以需要改成/
        // getTime() : 获取当前距离1970年午夜的零点的毫秒数。
        //把时间字符变成标准的时间格式
function getSpanTime(){
    var tagStr = "2019-1-1 0:0:0";
    var nowTime = new Date();
    var  tagTime = new Date(tagStr.replace(/-/g,"/"));//  2018-1-1 替换成 2018/1/1 
    var tagSpan = tagTime.getTime();
    var nowSpan = nowTime.getTime();
    var diffTime = tagSpan - nowSpan;
    if(diffTime>=0){
